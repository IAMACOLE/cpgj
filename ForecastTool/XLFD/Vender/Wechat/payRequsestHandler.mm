...
-(NSString*) createMd5Sign:(NSMutableDictionary*)dict
{
    ...
    {
        if (![[NSString stringWithFormat:@"%@",[dict objectForKey:categoryId]] isEqualToString:@""] && ![[NSString stringWithFormat:@"%@",categoryId] isEqualToString:@"sign"] && ![[NSString stringWithFormat:@"%@",categoryId] isEqualToString:@"key"])
        {
...
- ( NSMutableDictionary *)sendWXPay :(NSDictionary *)dic withTitle:(NSString *)order_name
{
    ...
    NSString *orderSn=[[NSString alloc] initWithFormat:@"%@",[dic objectForKey:@"orderSn"]];
    NSString *price=[[NSString alloc] initWithFormat:@"%@",[dic objectForKey:@"totalPrice"]];
    CGFloat money=[price floatValue];
    NSString *order_price= [NSString stringWithFormat:@"%d",(int)money];
    ...
    [packageParams setObject: orderSn           forKey:@"out_trade_no"];//商户订单号

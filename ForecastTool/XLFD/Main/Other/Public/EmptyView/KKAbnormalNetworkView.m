...
@interface KKAbnormalNetworkView ()
...
@implementation KKAbnormalNetworkView
...
- (void)reloadButtonClieked {
    ...
    if (self.customDelegate && [self.customDelegate respondsToSelector:@selector(KKAbnormalNetworkView_hitReloadButtonMethod)]) {
        [self.customDelegate KKAbnormalNetworkView_hitReloadButtonMethod];
    }
}

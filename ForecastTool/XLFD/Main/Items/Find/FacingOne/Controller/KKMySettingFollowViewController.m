//
//  KKMySettingFollowViewController.m
//  Kingkong_ios
//
...
@interface KKMySettingFollowViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation KKMySettingFollowViewController
...
- (void)sendNetWorking {
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@%@",MCIP,@"v2/gd-dsb/get-my-gd"];

...
@interface KKPK10TableViewCell()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation KKPK10TableViewCell
...
//    lineView.image = [UIImage imageNamed:@"icon-lotterydetail-horizontal-line"];

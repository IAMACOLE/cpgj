...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self){
        ...
        _tipView.center = CGPointMake(_tipView.center.x, -10);
        _tipView.textAlignment = NSTextAlignmentLeft;
        _tipView.textColor = MCUIColorBlack;
        _tipView.font = [UIFont boldSystemFontOfSize:12];
        _showTipView = [[UILabel alloc] initWithFrame:self.bounds];
        _showTipView.center = CGPointMake(_showTipView.center.x, _showTipView.center.y);
        _showTipView.textAlignment = NSTextAlignmentLeft;
        _showTipView.textColor = MCUIColorBlack;

//
//  KKRechargeRecordViewController.m
//  Kingkong_ios
//
...
@interface KKRechargeRecordViewController ()
<
...
@implementation KKRechargeRecordViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KKRechargeRecordCell * cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[KKRechargeRecordCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:identifier];
    }
